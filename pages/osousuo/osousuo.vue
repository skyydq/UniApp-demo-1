			...
			<scroll-view class="keyword-list-box" v-show="isShowKeywordList" scroll-y>
				<view class="keyword-entry" hover-class="keyword-entry-tap" v-for="row in keywordList" :key="row.keyword">
					...
					<view class="keyword-img" @tap="setkeyword(row)">
						<image src="../../static/sous/back.png"></image>
					</view>
				</view>
			</scroll-view>
			<scroll-view class="keyword-box" v-show="!isShowKeywordList" scroll-y>
				<view class="keyword-block" v-if="oldKeywordList.length>0">
					<view class="keyword-list-header">
						<view>历史搜索</view>
						<view>
							<image @tap="oldDelete" src="../../static/sous/delete.png"></image>
						</view>
					</view>
					<view class="keyword">
				...
				<view class="keyword-block">
					<view class="keyword-list-header">
						<view>热门搜索</view>
						<view>
							<image @tap="hotToggle" :src="'../../static/sous/attention'+forbid+'.png'"></image>
						</view>
					</view>
...
<script>
	...
	import mSearch from '@/components/sousuo/sousuo.vue';
	export default {
		data() {
			return {
				defaultKeyword: "",
...
<style>
	...
	.keyword-list-box {pborder-radius:10px 10px 0 0;background-color:#fff;}
	...
	.keyword-box {border-radius:10px 10px 0 0;background-color:#fff;}
